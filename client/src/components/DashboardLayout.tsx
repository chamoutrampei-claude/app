...
import { LayoutDashboard, LogOut, type LucideIcon, PanelLeft, Users } from "lucide-react";
...
const DEFAULT_MENU_ITEMS: DashboardMenuItem[] = [
...
type DashboardLayoutProps = {
  ...
  // Optional slot rendered at the top-right of the main content area (and in
  // the mobile top bar). Use for notifications, quick actions, etc.
  headerRight?: React.ReactNode;
};

export default function DashboardLayout({
  children,
  brandLabel = "Navigation",
  brandLogoSrc,

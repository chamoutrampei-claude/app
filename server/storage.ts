...
// Returns a presigned PUT URL the client can upload to directly (browser →
// S3, bypassing the app server). Pair with `storageGet` to obtain the
// public-readable path once the upload finishes.
